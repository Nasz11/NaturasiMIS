...
if (!clientName) {
  validationMsg.innerHTML = '<i class="fas fa-exclamation-circle"></i> Please select a client.';
  validationMsg.style.display = 'flex';
  return;
}
if (!orderDate) {
  validationMsg.innerHTML = '<i class="fas fa-exclamation-circle"></i> Please select an order date.';
  validationMsg.style.display = 'flex';
  return;
}
if (items.length === 0) {
  validationMsg.innerHTML = '<i class="fas fa-exclamation-circle"></i> Please add at least one product.';
  validationMsg.style.display = 'flex';
  return;
}
